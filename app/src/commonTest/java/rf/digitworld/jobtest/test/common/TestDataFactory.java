package rf.digitworld.jobtest.test.common;
...
import rf.digitworld.jobtest.data.model.Name;
import rf.digitworld.jobtest.data.model.Profile;
...
public class TestDataFactory {
    ...
    public static Profile makeProfile(String uniqueSuffix) {
        ...
        profile.email = "email" + uniqueSuffix + "@ribot.digitworld.uk";
